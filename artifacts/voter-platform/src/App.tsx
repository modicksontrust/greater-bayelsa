...
const clerkAppearance = {
  ...
  elements: {
    ...
    socialButtonsBlockButtonText: "text-foreground font-semibold text-sm",
    ...
    logoBox: "h-20 flex items-center justify-center mb-6",
    logoImage: "h-14 w-auto",
    socialButtonsBlockButton: "border border-border bg-white hover:bg-muted/40 transition-colors shadow-sm rounded-lg h-11 font-semibold",
